...
public class act1Validator : MonoBehaviour
{
    ...
    {
        bool isInput1Correct = inputField1.text == "200";
        bool isInput2Correct = inputField2.text == "300";
        bool isInput3Correct = inputField3.text == "150";
        ...
        else
        {
            ...
            if (!isInput1Correct) feedbackText.text += " Elma suyu miktarýný kontrol et";
            if (!isInput2Correct) feedbackText.text += " Portakal suyu miktarýný kontrol et";
            if (!isInput3Correct) feedbackText.text += " Limon suyu miktarýný kontrol et";
