...
public class act17notebookValidator : MonoBehaviour
{
    ...
    {
        bool isInput1Correct = inputField1.text == 30f.ToString("F2");
        ...
        else
        {
            ...
            if (!isInput1Correct) feedbackText.text += " 1 ay kaç gündür? dönüþtürücüden yardým alabilirsin.";
