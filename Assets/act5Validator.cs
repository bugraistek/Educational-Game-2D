...
public class act5Validator : MonoBehaviour
{
    ...
    {
        bool isInput1Correct = inputField1.text == "300.000";
        bool isInput2Correct = inputField2.text == "100.000";
        bool isInput3Correct = inputField3.text == "600.000";
        bool isInput4Correct = inputField4.text == "900.000";
        bool isInput5Correct = inputField5.text == "150.000";
        bool isInput6Correct = inputField6.text == "1.500.000";
