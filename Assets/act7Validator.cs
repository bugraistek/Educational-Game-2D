...
public class act7Validator : MonoBehaviour
{
    ...
    public void CheckInputs()
    {
        ...
        bool isInput2Correct = inputField2.text == "0,1";
        bool isInput3Correct = inputField3.text == "0,6";
        bool isInput4Correct = inputField4.text == "0,9";
        bool isInput5Correct = inputField5.text == "0,15";
        bool isInput6Correct = inputField6.text == "1,5";
