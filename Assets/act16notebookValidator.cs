...
public class act16notebookValidator : MonoBehaviour
{
    ...
    {
        bool isInput1Correct = inputField1.text == 24f.ToString("F2");
        ...
        else
        {
            ...
            if (!isInput1Correct) feedbackText.text += " 1 gün kaç saattir? dönüþtürücüden yardým alabilirsin.";
