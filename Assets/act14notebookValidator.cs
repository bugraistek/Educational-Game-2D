...
public class act14notebookValidator : MonoBehaviour
{
    ...
    {
        bool isInput1Correct = inputField1.text == 60f.ToString("F2");
        ...
        else
        {
            ...
            if (!isInput1Correct) feedbackText.text += " 1 dakika kaç saniyedir? dönüþtürücüden yardým alabilirsin.";
